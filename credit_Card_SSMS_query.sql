...
FROM 'Credit_Card_Financial_Dashboard-main/credit_card.csv'
WITH
(
...
FROM 'Credit_Card_Financial_Dashboard-main/customer_card.csv'
WITH
(
    FIELDTERMINATOR = ',',    -- Comma as field delimiter
    ROWTERMINATOR = '\n',     -- Newline as row delimiter
...
FROM 'Credit_Card_Financial_Dashboard-main/cc_add.csv'
WITH
(
    FIELDTERMINATOR = ',',    -- Comma as field delimiter
    ROWTERMINATOR = '\n',     -- Newline as row delimiter
...
BULK INSERT credit_card
FROM 'Credit_Card_Financial_Dashboard-main/cust_add.csv'
WITH
(
    FIELDTERMINATOR = ',',    -- Comma as field delimiter
    ROWTERMINATOR = '\n',     -- Newline as row delimiter
